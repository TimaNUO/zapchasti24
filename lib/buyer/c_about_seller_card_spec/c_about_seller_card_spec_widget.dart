...
import 'c_about_seller_card_spec_model.dart';
export 'c_about_seller_card_spec_model.dart';

class CAboutSellerCardSpecWidget extends StatefulWidget {
  const CAboutSellerCardSpecWidget({
    super.key,
    required this.phone,
  ...
  @override
  State<CAboutSellerCardSpecWidget> createState() =>
      _CAboutSellerCardSpecWidgetState();
}

class _CAboutSellerCardSpecWidgetState extends State<CAboutSellerCardSpecWidget>
    with TickerProviderStateMixin {
  late CAboutSellerCardSpecModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CAboutSellerCardSpecModel());
                            ...
                            children: [
                                            ...
                                            children: [
                                              Align(
                                                ...
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    '1wjzt8h7' /* Связаться с продавцом */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
                              ...
                              Padding(
                                ...
                                child: InkWell(
                                  ...
                                  highlightColor: Colors.transparent,
                                  onTap: () async {
                                    _model.chatCard = await RPCChatsGroup
