...
import 'c_buyer_ads_list_for_request_detail_model.dart';
export 'c_buyer_ads_list_for_request_detail_model.dart';

class CBuyerAdsListForRequestDetailWidget extends StatefulWidget {
  const CBuyerAdsListForRequestDetailWidget({
    super.key,
  ...
  @override
  State<CBuyerAdsListForRequestDetailWidget> createState() =>
      _CBuyerAdsListForRequestDetailWidgetState();
}

class _CBuyerAdsListForRequestDetailWidgetState
    extends State<CBuyerAdsListForRequestDetailWidget>
    with TickerProviderStateMixin {
  late CBuyerAdsListForRequestDetailModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CBuyerAdsListForRequestDetailModel());
                                        ...
                                        Align(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              '6tz170cp' /* Связаться с продавцом */,
                                            ),
