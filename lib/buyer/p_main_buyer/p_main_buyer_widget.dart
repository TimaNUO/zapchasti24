...
import 'p_main_buyer_model.dart';
export 'p_main_buyer_model.dart';

class PMainBuyerWidget extends StatefulWidget {
  const PMainBuyerWidget({super.key});

  static String routeName = 'pMainBuyer';
  static String routePath = '/pMainBuyer';

  @override
  State<PMainBuyerWidget> createState() => _PMainBuyerWidgetState();
}

class _PMainBuyerWidgetState extends State<PMainBuyerWidget>
    with TickerProviderStateMixin {
  late PMainBuyerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PMainBuyerModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.apiResult1l8 = await SupabaseInfoGroup.vehicleUserInfoCall.call(
        userIdApp: FFAppState().userIdApp,
      );

      _model.countVehicle =
          (_model.apiResult1l8?.getHeader('content-range') ?? '');
      _model.appLastBuild = _model.apiAppLastBuild?.firstOrNull?.latestBuild;
      safeSetState(() {});
      _model.vehicle = functions.extractTotal(_model.countVehicle);
      safeSetState(() {});
      if (_model.vehicle == 0) {
                              ...
                              children: [
                                ...
                                Align(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      context
                                          .pushNamed(PAddBuyerWidget.routeName);
                                    },
                                    child: Container(
                                      width: MediaQuery.sizeOf(context).width *
                                          1.0,
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        FutureBuilder<List<SpecializationsRow>>(
                                          future:
                                              SpecializationsTable().queryRows(
                                            queryFn: (q) => q
                                                .eqOrNull(
                                                  'is_active',
                                                  true,
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            List<SpecializationsRow>
                                                gridViewSpecializationsRowList =
                                                snapshot.data!;
                                            ...
                                            return GridView.builder(
                                              ...
                                              itemBuilder:
                                                ...
                                                final gridViewSpecializationsRow =
                                                    gridViewSpecializationsRowList[
                                                        gridViewIndex];
                                                return InkWell(
                                                  splashColor:
