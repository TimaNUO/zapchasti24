...
import 'p_account_buyer_model.dart';
export 'p_account_buyer_model.dart';

class PAccountBuyerWidget extends StatefulWidget {
  const PAccountBuyerWidget({super.key});

  static String routeName = 'pAccountBuyer';
  static String routePath = '/pAccountBuyer';

  @override
  State<PAccountBuyerWidget> createState() => _PAccountBuyerWidgetState();
}

class _PAccountBuyerWidgetState extends State<PAccountBuyerWidget> {
  late PAccountBuyerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PAccountBuyerModel());
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'yy036msl' /* Мы в социальных сетях */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .headlineSmall
                                    .override(
