...
import 'c_edit_car_details_model.dart';
export 'c_edit_car_details_model.dart';

class CEditCarDetailsWidget extends StatefulWidget {
  const CEditCarDetailsWidget({super.key});

  @override
  State<CEditCarDetailsWidget> createState() => _CEditCarDetailsWidgetState();
}

class _CEditCarDetailsWidgetState extends State<CEditCarDetailsWidget>
    with TickerProviderStateMixin {
  late CEditCarDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CEditCarDetailsModel());
                          ...
                          child: Column(
                            ...
                            children: [
                                    ...
                                    onPressed: () async {
                                      ...
                                      if (selectedMedia != null &&
                                        ...
                                        try {
                                          ...
                                          _model.isDataUploading_uploadDataZck =
                                              false;
                                        }
                              ...
                              Align(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    if (functions.isValidVIN(_model
                                      ...
                                      if ((_model.apiResult85a?.succeeded ??
                                          true)) {
                                        await showDialog(
                                          context: context,
                                        ...
                                        await showDialog(
                                          ...
                                          builder: (alertDialogContext) {
                                            return AlertDialog(
                                              title: Text('Ошибка'),
                                              content: Text((_model.apiResult85a
                                                          ?.jsonBody ??
                                                      '')
                                                  .toString()),
                                              actions: [
                                ...
                                Align(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      if ((_model.apiResulto0i?.succeeded ??
                                          true)) {
                                        await showDialog(
                                          context: context,
                                          builder: (alertDialogContext) {
                                        ...
                                        await showDialog(
                                          ...
                                          builder: (alertDialogContext) {
                                            return AlertDialog(
                                              title: Text('Ошибка'),
                                              content: Text((_model.apiResulto0i
                                                          ?.jsonBody ??
                                                      '')
                                                  .toString()),
                                              actions: [
