                      ...
                      children: [
                        Text(
                          FFLocalizations.of(context).getText(
                            'drs0iu8k' /* Добавление ассортимента запчас... */,
                          ),
                          style:
                                ...
                                Align(
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Text(
                                        FFLocalizations.of(context).getText(
                                          'urobjjt2' /* Состояние автозапчастей */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    ...
                                    if (selectedMedia != null &&
                                      ...
                                      safeSetState(() => _model
                                              .isDataUploading_uploadDataCn3b =
                                          true);
                                      ...
                                      try {
                                        ...
                                        _model.isDataUploading_uploadDataCn3b =
                                            false;
                                      }
                                      if (selectedUploadedFiles.length ==
                                          ...
                                          downloadUrls.length ==
                                              selectedMedia.length) {
                                        safeSetState(() {
                                          _model.uploadedLocalFiles_uploadDataCn3b =
                                              selectedUploadedFiles;
                                          _model.uploadedFileUrls_uploadDataCn3b =
                                              downloadUrls;
                                        });
                                      } else {
                                        safeSetState(() {});
                                    ...
                                    _model.allPhotoList = functions
                                        .merge15Lists(
                                            ...
                                            _model
                                                .uploadedFileUrls_uploadDataCn3b
                                                .toList())
                                        .toList()
                                        .cast<String>();
                                    safeSetState(() {});
