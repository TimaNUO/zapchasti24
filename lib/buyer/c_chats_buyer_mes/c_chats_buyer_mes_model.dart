...
import 'c_chats_buyer_mes_widget.dart' show CChatsBuyerMesWidget;
import 'package:flutter/material.dart';
import 'package:record/record.dart';

class CChatsBuyerMesModel extends FlutterFlowModel<CChatsBuyerMesWidget> {
  ...
  // Stores action output result for [Backend Call - API (ch presence open)] action in cChatsBuyerMes widget.
  ApiCallResponse? presenceOpenOutput;
  // Stores action output result for [Backend Call - API (Chats Messages Buyer Info)] action in cChatsBuyerMes widget.
  ApiCallResponse? messagesInit;
  // Stores action output result for [Custom Action - mergeMessageListsAsc] action in cChatsBuyerMes widget.
  List<dynamic>? mergeMessageListsAscOutput;
  // Stores action output result for [Backend Call - API (ch mark chat read)] action in cChatsBuyerMes widget.
  ApiCallResponse? chatReadOutputI;
  // Stores action output result for [Backend Call - API (ch presence close)] action in cChatsBuyerMes widget.
  ...
  List<ChatsRow>? rowChat;
  // State field(s) for ColumnChat widget.
  ScrollController? columnChatScrollController;
  // Stores action output result for [Backend Call - API (Chats Messages Buyer Info)] action in Row widget.
  ...
  bool isDataUploading_uploadDataAudioS = false;
  FFUploadedFile uploadedLocalFile_uploadDataAudioS =
      FFUploadedFile(bytes: Uint8List.fromList([]), originalFilename: '');
  String uploadedFileUrl_uploadDataAudioS = '';
  ...
  bool isDataUploading_uploadDataVideoS = false;
  FFUploadedFile uploadedLocalFile_uploadDataVideoS =
      FFUploadedFile(bytes: Uint8List.fromList([]), originalFilename: '');
  String uploadedFileUrl_uploadDataVideoS = '';

  bool isDataUploading_uploadDataPhotoS = false;
  FFUploadedFile uploadedLocalFile_uploadDataPhotoS =
      FFUploadedFile(bytes: Uint8List.fromList([]), originalFilename: '');
  String uploadedFileUrl_uploadDataPhotoS = '';
