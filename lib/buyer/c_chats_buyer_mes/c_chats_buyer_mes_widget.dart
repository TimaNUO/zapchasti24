...
import '/buyer/c_about_seller_card/c_about_seller_card_widget.dart';
...
export 'c_chats_buyer_mes_model.dart';

class CChatsBuyerMesWidget extends StatefulWidget {
  const CChatsBuyerMesWidget({
    super.key,
  ...
  @override
  State<CChatsBuyerMesWidget> createState() => _CChatsBuyerMesWidgetState();
}

class _CChatsBuyerMesWidgetState extends State<CChatsBuyerMesWidget>
    with TickerProviderStateMixin {
  late CChatsBuyerMesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CChatsBuyerMesModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      safeSetState(() {});
      _model.messagesInit =
          await SupabaseInfoGroup.chatsMessagesBuyerInfoCall.call(
        chatID: widget.chatID,
        offset: 0,
        limit: 10,
        currentJwtToken: currentJwtToken,
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                _model.rowChat = await ChatsTable().queryRows(
                                  queryFn: (q) => q
                                      .eqOrNull(
                                        'id',
                                        widget.chatID,
                                ...
                                await showModalBottomSheet(
                                  ...
                                  builder: (context) {
                                    return Padding(
                                      ...
                                      child: CAboutSellerCardWidget(
                                        sellerID: _model
                                            .rowChat!.firstOrNull!.sellerId,
                                      ),
                                    );
                                  },
