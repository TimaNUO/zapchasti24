...
import 'c_buyer_ads_list_model.dart';
export 'c_buyer_ads_list_model.dart';

class CBuyerAdsListWidget extends StatefulWidget {
  const CBuyerAdsListWidget({super.key});

  @override
  State<CBuyerAdsListWidget> createState() => _CBuyerAdsListWidgetState();
}

class _CBuyerAdsListWidgetState extends State<CBuyerAdsListWidget>
    with TickerProviderStateMixin {
  late CBuyerAdsListModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CBuyerAdsListModel());
