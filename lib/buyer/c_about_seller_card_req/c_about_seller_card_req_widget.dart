...
import 'c_about_seller_card_req_model.dart';
export 'c_about_seller_card_req_model.dart';

class CAboutSellerCardReqWidget extends StatefulWidget {
  const CAboutSellerCardReqWidget({
    super.key,
    required this.phone,
  ...
  @override
  State<CAboutSellerCardReqWidget> createState() =>
      _CAboutSellerCardReqWidgetState();
}

class _CAboutSellerCardReqWidgetState extends State<CAboutSellerCardReqWidget>
    with TickerProviderStateMixin {
  late CAboutSellerCardReqModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CAboutSellerCardReqModel());
                                            ...
                                            children: [
                                              Align(
                                                ...
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'aom6ufqr' /* Связаться с продавцом */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
