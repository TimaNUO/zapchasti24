...
import 'c_buyer_request_rejected_list_model.dart';
export 'c_buyer_request_rejected_list_model.dart';

class CBuyerRequestRejectedListWidget extends StatefulWidget {
  const CBuyerRequestRejectedListWidget({
    super.key,
  ...
  @override
  State<CBuyerRequestRejectedListWidget> createState() =>
      _CBuyerRequestRejectedListWidgetState();
}

class _CBuyerRequestRejectedListWidgetState
    extends State<CBuyerRequestRejectedListWidget>
    with TickerProviderStateMixin {
  late CBuyerRequestRejectedListModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CBuyerRequestRejectedListModel());
