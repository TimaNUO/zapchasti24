...
import 'c_models_check_box_list_tile_true_model.dart';
export 'c_models_check_box_list_tile_true_model.dart';

class CModelsCheckBoxListTileTrueWidget extends StatefulWidget {
  const CModelsCheckBoxListTileTrueWidget({super.key});

  @override
  State<CModelsCheckBoxListTileTrueWidget> createState() =>
      _CModelsCheckBoxListTileTrueWidgetState();
}

class _CModelsCheckBoxListTileTrueWidgetState
    extends State<CModelsCheckBoxListTileTrueWidget> {
  late CModelsCheckBoxListTileTrueModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CModelsCheckBoxListTileTrueModel());
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintText:
                                        ...
                                        'zoa6m1oi' /* Введите название модели */,
                                      ),
                      ...
                      Builder(
                        builder: (context) {
                          if (_model.keyWord != null && _model.keyWord != '') {
                            return FutureBuilder<List<CarModelsRow>>(
                              future: CarModelsTable().queryRows(
                                queryFn: (q) => q
                                    .eqOrNull(
                                      'car_brand_id',
                                    ...
                                    .ilike(
                                      'model',
                                      functions
                                          .wrapWithPercent(_model.keyWord!),
                                    )
                                    .order('model', ascending: true),
                              ),
                              builder: (context, snapshot) {
                                ...
                                List<CarModelsRow> listViewCarModelsRowList =
                                    snapshot.data!;
                                ...
                                return ListView.builder(
                                  ...
                                  shrinkWrap: true,
                                  scrollDirection: Axis.vertical,
                                  itemCount: listViewCarModelsRowList.length,
                                  itemBuilder: (context, listViewIndex) {
                                    final listViewCarModelsRow =
                                        listViewCarModelsRowList[listViewIndex];
                                    return Container(
                                      decoration: BoxDecoration(
                                        border: Border.all(
                                          color: FlutterFlowTheme.of(context)
