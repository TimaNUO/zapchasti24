...
import 'c_models_check_box_list_tile_model.dart';
export 'c_models_check_box_list_tile_model.dart';

class CModelsCheckBoxListTileWidget extends StatefulWidget {
  const CModelsCheckBoxListTileWidget({super.key});

  @override
  State<CModelsCheckBoxListTileWidget> createState() =>
      _CModelsCheckBoxListTileWidgetState();
}

class _CModelsCheckBoxListTileWidgetState
    extends State<CModelsCheckBoxListTileWidget> {
  late CModelsCheckBoxListTileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CModelsCheckBoxListTileModel());
                            ...
                            return Visibility(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  if (FFAppState()
                                      .modelsIDListApp
                                      .contains(listViewOneCarModelsRow.id)) {
                                    FFAppState().removeFromModelsIDListApp(
