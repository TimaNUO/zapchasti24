...
import 'c_details_check_box_list_tile_model.dart';
export 'c_details_check_box_list_tile_model.dart';

class CDetailsCheckBoxListTileWidget extends StatefulWidget {
  const CDetailsCheckBoxListTileWidget({super.key});

  @override
  State<CDetailsCheckBoxListTileWidget> createState() =>
      _CDetailsCheckBoxListTileWidgetState();
}

class _CDetailsCheckBoxListTileWidgetState
    extends State<CDetailsCheckBoxListTileWidget> {
  late CDetailsCheckBoxListTileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CDetailsCheckBoxListTileModel());
                    ...
                    Material(
                      ...
                      child: Theme(
                        ...
                        child: CheckboxListTile(
                          value: _model.checkboxListTileAllValue ??=
