...
import 'c_details_check_box_list_tile_false_model.dart';
export 'c_details_check_box_list_tile_false_model.dart';

class CDetailsCheckBoxListTileFalseWidget extends StatefulWidget {
  const CDetailsCheckBoxListTileFalseWidget({super.key});

  @override
  State<CDetailsCheckBoxListTileFalseWidget> createState() =>
      _CDetailsCheckBoxListTileFalseWidgetState();
}

class _CDetailsCheckBoxListTileFalseWidgetState
    extends State<CDetailsCheckBoxListTileFalseWidget> {
  late CDetailsCheckBoxListTileFalseModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CDetailsCheckBoxListTileFalseModel());
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'r77192w3' /* Список категорий автозапчастей */,
                        ),
                    ...
                    Material(
                      ...
                      child: Theme(
                        ...
                        child: CheckboxListTile(
                          value: _model.checkboxListTileAllValue ??= false,
                          onChanged: (newValue) async {
                            safeSetState(() =>
                                _model.checkboxListTileAllValue = newValue!);
                            if (newValue!) {
                              _model.allCategories =
                                  await PartsCategoryTable().queryRows(
                                queryFn: (q) => q,
                              );
                              FFAppState().categoriesIDListApp =
                                  _model.allCategories!
                                      ...
                                      .toList()
                                      .cast<int>();
                              FFAppState().isAllCategories = true;
                              safeSetState(() {});
