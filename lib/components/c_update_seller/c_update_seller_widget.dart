...
import 'c_update_seller_model.dart';
export 'c_update_seller_model.dart';

class CUpdateSellerWidget extends StatefulWidget {
  const CUpdateSellerWidget({super.key});

  @override
  State<CUpdateSellerWidget> createState() => _CUpdateSellerWidgetState();
}

class _CUpdateSellerWidgetState extends State<CUpdateSellerWidget>
    with TickerProviderStateMixin {
  late CUpdateSellerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CUpdateSellerModel());
                      ...
                      Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'd7ociowd' /* Для корректной работы приложен... */,
                          ),
                                ...
                                Align(
                                  ...
                                  child: FFButtonWidget(
                                    ...
                                    text: FFLocalizations.of(context).getText(
                                      '7kc2ljv9' /* Перейти в Google Play */,
                                    ),
