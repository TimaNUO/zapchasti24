...
import 'c_back_components_model.dart';
export 'c_back_components_model.dart';

class CBackComponentsWidget extends StatefulWidget {
  const CBackComponentsWidget({super.key});

  @override
  State<CBackComponentsWidget> createState() => _CBackComponentsWidgetState();
}

class _CBackComponentsWidgetState extends State<CBackComponentsWidget>
    with TickerProviderStateMixin {
  late CBackComponentsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CBackComponentsModel());
