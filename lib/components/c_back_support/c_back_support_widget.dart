...
import 'c_back_support_model.dart';
export 'c_back_support_model.dart';

class CBackSupportWidget extends StatefulWidget {
  const CBackSupportWidget({super.key});

  @override
  State<CBackSupportWidget> createState() => _CBackSupportWidgetState();
}

class _CBackSupportWidgetState extends State<CBackSupportWidget>
    with TickerProviderStateMixin {
  late CBackSupportModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CBackSupportModel());
