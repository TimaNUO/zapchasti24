...
import '/seller/c_contract_seller/c_contract_seller_widget.dart';
import '/seller/c_edit_about_seller/c_edit_about_seller_widget.dart';
...
import '/seller/c_seller_specializations/c_seller_specializations_widget.dart';
...
import 'p_account_seller_model.dart';
export 'p_account_seller_model.dart';

class PAccountSellerWidget extends StatefulWidget {
  const PAccountSellerWidget({super.key});

  static String routeName = 'pAccountSeller';
  static String routePath = '/pAccountSeller';

  @override
  State<PAccountSellerWidget> createState() => _PAccountSellerWidgetState();
}

class _PAccountSellerWidgetState extends State<PAccountSellerWidget> {
  late PAccountSellerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PAccountSellerModel());
                        ...
                        children: [
                                                  ...
                                                  child: ClipRRect(
                                                    borderRadius:
                                                        BorderRadius.circular(
                                                            8.0),
                                                    child: SvgPicture.asset(
                                                      'assets/images/kabinet_prodavtsa_foto_profilya.svg',
                                                      width: 70.0,
                                                      height: 70.0,
                                                      fit: BoxFit.contain,
                                                    ),
                                        ...
                                        children: [
                                          ...
                                          Align(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                '60o1ge7z' /* Редактировать профиль */,
                                              ),
                                              style: FlutterFlowTheme.of(
                                                      context)
                                                  .bodyMedium
                                ...
                                builder: (context) {
                                  return GestureDetector(
                                    ...
                                    child: Padding(
                                      ...
                                      child: CSellerFilterAdListEditWidget(),
                                    ),
                                  );
                                },
                              ).then((value) => safeSetState(() {}));
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            'vz98qez4' /* Настройка моих продаж */,
                                          ),
                              ...
                              await showModalBottomSheet(
                                ...
                                builder: (context) {
                                  return GestureDetector(
                                    ...
                                    child: Padding(
                                      padding: MediaQuery.viewInsetsOf(context),
                                      child: CSellerSpecializationsWidget(
                                        selectedSpecIds: _model
                                            .apiResultSpecList
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  't3yn63qw' /* Мы в социальных сетях */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .headlineSmall
                                    .override(
                          ...
                          Row(
                            ...
                            children: [
                              InkWell(
                                ...
                                onTap: () async {
                                  await launchURL(
                                      'https://www.instagram.com/zapchasti_24.kz?igsh=d240Z2xlMW56NjR0');
                                },
                                child: Container(
                                  width:
                                          ...
                                          children: [
                                            ClipRRect(
                                              borderRadius:
                                                  BorderRadius.circular(0.0),
                                              child: SvgPicture.asset(
                                                'assets/images/instagram-1-svgrepo-com_1.svg',
                                                height: 32.0,
                                                fit: BoxFit.contain,
                                              ),
                                            ),
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                ...
                                context.goNamedAuth(
                                    PStartReqWidget.routeName, context.mounted);
                              },
                              child: Container(
                                height: 60.0,
                                decoration: BoxDecoration(
