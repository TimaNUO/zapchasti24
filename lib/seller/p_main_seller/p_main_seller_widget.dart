...
import '/seller/c_seller_ads_list/c_seller_ads_list_widget.dart';
                            ...
                            child: Column(
                              ...
                              children: [
                                FutureBuilder<ApiCallResponse>(
                                  future: SupabaseInfoGroup.adminBannersInfoCall
                                      .call(
                                    placeID: 222,
                                  ),
                                  builder: (context, snapshot) {
                                          ...
                                          Align(
                                            ...
                                            child: FFButtonWidget(
                                              ...
                                              text: FFLocalizations.of(context)
                                                  .getText(
                                                'kicw7p58' /* Перейти в Google Play */,
                                              ),
                                              options: FFButtonOptions(
                                                width: 200.0,
                                                height: 40.0,
                        ...
                        SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        '6y7ta4rr' /* Состояние автозапчастей */,
                                                      ),
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                              ...
                              FutureBuilder<ApiCallResponse>(
                                future: SupabaseInfoGroup.sellerFiltersInfoCall
                                    .call(
                                  sellerID: FFAppState().userIdApp,
                                ),
                                builder: (context, snapshot) {
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child: Text(
                                                                      FFLocalizations.of(
                                                                              context)
                                                                          .getText(
                                                                        'tary8suj' /* Состояние автозапчастей */,
                                                                      ),
                                                                      style: FlutterFlowTheme.of(
                                                                              context)
                                                                          .bodyMedium
