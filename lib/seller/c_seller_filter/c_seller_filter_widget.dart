...
import 'c_seller_filter_model.dart';
export 'c_seller_filter_model.dart';

class CSellerFilterWidget extends StatefulWidget {
  const CSellerFilterWidget({super.key});

  @override
  State<CSellerFilterWidget> createState() => _CSellerFilterWidgetState();
}

class _CSellerFilterWidgetState extends State<CSellerFilterWidget>
    with TickerProviderStateMixin {
  late CSellerFilterModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CSellerFilterModel());
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                            ...
                            await showModalBottomSheet(
                              ...
                              builder: (context) {
                                return Padding(
                                  ...
                                  child: CBrandsCheckBoxListTileFilterWidget(),
                                );
                              },
                        ...
                        FutureBuilder<ApiCallResponse>(
                          future: SupabaseInfoGroup.sellerFiltersInfoCall.call(
                                                                ...
                                                                await showDialog<
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return AlertDialog(
                                                                          ...
                                                                          content:
                                                                              Text('Вы действительно хотите удалить фильтр?'),
                                                                          actions: [
                                                                            TextButton(
                                                                ...
                                                                await showDialog(
                                                                  ...
                                                                  builder:
                                                                    ...
                                                                    return AlertDialog(
                                                                      title: Text(
                                                                          'Ошибка'),
                                                                      content: Text((_model.apiResultwwyCopy?.jsonBody ??
                                                                              '')
                                                                          .toString()),
                                                                      actions: [
                                                                        TextButton(
                                                            ...
                                                            child: Padding(
                                                              ...
                                                              child: Text(
                                                                FFLocalizations.of(
                                                                        context)
                                                                    .getText(
                                                                  'scuy6gcn' /* Состояние автозапчастей */,
                                                                ),
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .bodyMedium
