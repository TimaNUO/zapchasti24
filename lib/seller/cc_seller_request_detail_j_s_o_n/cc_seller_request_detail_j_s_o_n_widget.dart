...
import 'cc_seller_request_detail_j_s_o_n_model.dart';
export 'cc_seller_request_detail_j_s_o_n_model.dart';

class CcSellerRequestDetailJSONWidget extends StatefulWidget {
  const CcSellerRequestDetailJSONWidget({
    super.key,
  ...
  @override
  State<CcSellerRequestDetailJSONWidget> createState() =>
      _CcSellerRequestDetailJSONWidgetState();
}

class _CcSellerRequestDetailJSONWidgetState
    extends State<CcSellerRequestDetailJSONWidget>
    with TickerProviderStateMixin {
  late CcSellerRequestDetailJSONModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CcSellerRequestDetailJSONModel());
                                                      ...
                                                      child: Padding(
                                                        ...
                                                        child: Text(
                                                          FFLocalizations.of(
                                                                  context)
                                                              .getText(
                                                            'gi0nswv3' /* Состояние автозапчастей */,
                                                          ),
                                                          textAlign:
                                                              TextAlign.center,
                                                          style: FlutterFlowTheme
