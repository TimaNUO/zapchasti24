...
import 'c_seller_notif_to_request_model.dart';
export 'c_seller_notif_to_request_model.dart';

class CSellerNotifToRequestWidget extends StatefulWidget {
  const CSellerNotifToRequestWidget({
    super.key,
  ...
  @override
  State<CSellerNotifToRequestWidget> createState() =>
      _CSellerNotifToRequestWidgetState();
}

class _CSellerNotifToRequestWidgetState
    extends State<CSellerNotifToRequestWidget> with TickerProviderStateMixin {
  late CSellerNotifToRequestModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CSellerNotifToRequestModel());
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Align(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              '0hsgs8yv' /* Связаться с покупателем */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
