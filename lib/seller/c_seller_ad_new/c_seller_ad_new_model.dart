...
import 'c_seller_ad_new_widget.dart' show CSellerAdNewWidget;
import 'package:flutter/material.dart';

class CSellerAdNewModel extends FlutterFlowModel<CSellerAdNewWidget> {
  ...
  bool isDataUploading_uploadDataCn3s = false;
  List<FFUploadedFile> uploadedLocalFiles_uploadDataCn3s = [];
  List<String> uploadedFileUrls_uploadDataCn3s = [];
