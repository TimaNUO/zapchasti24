...
import '/seller/c_seller_request_rejected_detail/c_seller_request_rejected_detail_widget.dart';
                          ...
                          Padding(
                            ...
                            child: Builder(
                              builder: (context) {
                                ...
                                if (sellerRequestRejectedBody.isEmpty) {
                                                      ...
                                                      child: Padding(
                                                        padding: MediaQuery
                                                            .viewInsetsOf(
                                                                context),
                                                        child:
                                                            CSellerRequestRejectedDetailWidget(
                                                          requestID:
                                                              getJsonField(
                                                            sellerRequestRejectedBodyItem,
                                                            r'''$.request_id''',
                                                                              ...
                                                                              child: FlutterFlowExpandedImageView(
                                                                                image: CachedNetworkImage(
                                                                                  ...
                                                                                  imageUrl: getJsonField(
                                                                                    containerSellerRequestRejectedONEInfoResponse.jsonBody,
                                                                                    r'''$[0].photo_url[0]''',
                                                                                  ).toString(),
                                                                                  fit: BoxFit.contain,
                                                                                ),
