...
import 'c_new_ad_seller_model.dart';
export 'c_new_ad_seller_model.dart';

class CNewAdSellerWidget extends StatefulWidget {
  const CNewAdSellerWidget({super.key});

  @override
  State<CNewAdSellerWidget> createState() => _CNewAdSellerWidgetState();
}

class _CNewAdSellerWidgetState extends State<CNewAdSellerWidget>
    with TickerProviderStateMixin {
  late CNewAdSellerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CNewAdSellerModel());
                      ...
                      children: [
                        ...
                        Text(
                          FFLocalizations.of(context).getText(
                            'gbngi4rv' /* Добавление объявления на */,
                          ),
                          style:
                            ...
                            if (FFAppState().isAllModels) {
                              ...
                              await showModalBottomSheet(
                                ...
                                builder: (context) {
                                  return Padding(
                                    padding: MediaQuery.viewInsetsOf(context),
                                    child: CModelsCheckBoxListTileFalseWidget(),
                                  );
                                },
                              ).then((value) => safeSetState(() {}));
                            }
                          ...
                          child: Builder(
                            builder: (context) {
                              ...
                              return Wrap(
                                ...
                                children: List.generate(modelItem1.length,
                                    (modelItem1Index) {
                                  final modelItem1Item =
                                      modelItem1[modelItem1Index];
                                  return Container(
                                    decoration: BoxDecoration(
                                      color:
                                    ...
                                    child: Padding(
                                      ...
                                      child: FutureBuilder<List<CarModelsRow>>(
                            ...
                            if (FFAppState().isAllCategories) {
                              await showModalBottomSheet(
                                ...
                                builder: (context) {
                                  return Padding(
                                    padding: MediaQuery.viewInsetsOf(context),
                                    child: CDetailsCheckBoxListTileTrueWidget(),
                                  );
                                },
                              ).then((value) => safeSetState(() {}));
                            } else {
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Builder(
                                builder: (context) {
                                  final photoReq = _model.allPhotoList.toList();
                                  if (photoReq.isEmpty) {
                                    return Center(
                                      child: SvgPicture.asset(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              ...
                              if (selectedMedia != null &&
                                ...
                                safeSetState(() => _model
                                    .isDataUploading_uploadData0j73 = true);
                                ...
                                try {
                                  ...
                                  _model.isDataUploading_uploadData0j73 = false;
                                }
                                if (selectedUploadedFiles.length ==
                                    ...
                                    downloadUrls.length ==
                                        selectedMedia.length) {
                                  safeSetState(() {
                                    _model.uploadedLocalFiles_uploadData0j73 =
                                        selectedUploadedFiles;
                                    _model.uploadedFileUrls_uploadData0j73 =
                                        downloadUrls;
                                  });
                                } else {
                                  safeSetState(() {});
                        ...
                        Align(
                          ...
                          child: Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                if ((FFAppState().newFilterModels.isNotEmpty) &&
                                    (FFAppState()
                                        .newFilterCategories
                                        .isNotEmpty) &&
                                  ...
                                  FFAppState().yearTo =
                                      _model.dropDownToValue != null
                                          ...
                                          : 61;
                                  safeSetState(() {});
                                  _model.apiResultp10 = await SupabaseInfoGroup
                                      .upsertAdInfoCall
                                      .call(
                                    ...
                                    price: int.tryParse(
                                        _model.textController2.text),
                                    currencyId: _model.dropDownCurrencyValue,
                                    photoUrlList: _model.allPhotoList,
                                  );

                                  if ((_model.apiResultp10?.succeeded ??
                                      true)) {
                              ...
                              text: FFLocalizations.of(context).getText(
                                'a5pl9wdk' /* Опубликовать объявление */,
                              ),
