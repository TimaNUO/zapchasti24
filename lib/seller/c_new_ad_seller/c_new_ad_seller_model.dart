...
import 'c_new_ad_seller_widget.dart' show CNewAdSellerWidget;
import 'package:flutter/material.dart';

class CNewAdSellerModel extends FlutterFlowModel<CNewAdSellerWidget> {
  ...
  bool isDataUploading_uploadData0j73 = false;
  List<FFUploadedFile> uploadedLocalFiles_uploadData0j73 = [];
  List<String> uploadedFileUrls_uploadData0j73 = [];
  ...
  // Stores action output result for [Backend Call - API (Upsert Ad Info)] action in ButtonPublic widget.
  ApiCallResponse? apiResultp10;
