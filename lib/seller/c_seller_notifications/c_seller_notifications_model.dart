  ...
  PagingController<ApiPagingParams, dynamic> _createListViewController(
    ...
    return controller
      ..addPageRequestListener(
          listViewNotificationsNewRequestByAllFiltersInfoPage);
  }

  void listViewNotificationsNewRequestByAllFiltersInfoPage(
          ApiPagingParams nextPageMarker) =>
      listViewApiCall!(nextPageMarker)
          .then((listViewNotificationsNewRequestByAllFiltersInfoResponse) {
        final pageItems =
            (listViewNotificationsNewRequestByAllFiltersInfoResponse.jsonBody ??
                    [])
                .toList() as List;
        ...
        listViewPagingController?.appendPage(
          ...
          (pageItems.length > 0)
              ? ApiPagingParams(
                  ...
                  lastResponse:
                      listViewNotificationsNewRequestByAllFiltersInfoResponse,
                )
              : null,
        );
      });
