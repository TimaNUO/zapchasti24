...
import '/seller/c_seller_notif_to_request/c_seller_notif_to_request_widget.dart';
import 'dart:async';
...
class CSellerNotificationsWidget extends StatefulWidget {
  ...
  State<CSellerNotificationsWidget> createState() =>
      _CSellerNotificationsWidgetState();
}

class _CSellerNotificationsWidgetState extends State<CSellerNotificationsWidget>
    with TickerProviderStateMixin {
  late CSellerNotificationsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CSellerNotificationsModel());
                        ...
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'n0q3ckwp' /* Новые заявки по вашим фильтрам */,
                            ),
                                                                        ...
                                                                        Builder(
                                                                          builder:
                                                                            ...
                                                                            return Wrap(
                                                                              ...
                                                                              children: List.generate(categoryPart.length, (categoryPartIndex) {
