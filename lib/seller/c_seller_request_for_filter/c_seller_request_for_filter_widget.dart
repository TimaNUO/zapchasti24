                          ...
                          children: [
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return FlutterFlowDropDown<int>(
                                    ...
                                    hintText:
                                      ...
                                      '877rl3vq' /* Выберите страну покупателя */,
                                    ),
                                    icon: Icon(
                            ...
                            InkWell(
                              ...
                              onTap: () async {
                                ...
                                safeSetState(() {
                                  _model.dropDownCountryValueController?.value =
                                      null;
                                  _model.dropDownCountryValue = null;
                                });
                                safeSetState(() {
                                ...
                                child: FutureBuilder<List<CitiesRow>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    return FlutterFlowDropDown<int>(
                                      ...
                                      hintText:
                                          FFLocalizations.of(context).getText(
                                        'g6ixjl9a' /* Выберите город покупателя */,
                                      ),
                                      icon: Icon(
                                        Icons.keyboard_arrow_down_rounded,
                                        color: FlutterFlowTheme.of(context)
                          ...
                          builder: (context) {
                            ...
                            return ListView.separated(
                              ...
                              itemBuilder: (context, actualREQIndex) {
                                final actualREQItem = actualREQ[actualREQIndex];
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Text(
                                                                      getJsonField(
                                                                        containerSellerRequestONEInfoResponse
                                                                            .jsonBody,
                                                                        r'''$[0].vehicle_users.data_users.cities.countries.country''',
                                                                      ).toString(),
                                                                      style: FlutterFlowTheme.of(
                                                                              context)
                                                                          .bodyMedium
                                                                    ...
                                                                    Text(
                                                                      getJsonField(
                                                                        containerSellerRequestONEInfoResponse
                                                                            .jsonBody,
                                                                        r'''$[0].vehicle_users.data_users.cities.city''',
                                                                      ).toString(),
                                                                      style: FlutterFlowTheme.of(
                                                                              context)
                                                                          .bodyMedium
