...
import 'c_seller_ads_list_model.dart';
export 'c_seller_ads_list_model.dart';

class CSellerAdsListWidget extends StatefulWidget {
  const CSellerAdsListWidget({super.key});

  @override
  State<CSellerAdsListWidget> createState() => _CSellerAdsListWidgetState();
}

class _CSellerAdsListWidgetState extends State<CSellerAdsListWidget>
    with TickerProviderStateMixin {
  late CSellerAdsListModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CSellerAdsListModel());
                    ...
                    child: Column(
                      ...
                      children: [
                            ...
                            await showModalBottomSheet(
                              ...
                              builder: (context) {
                                return Padding(
                                  ...
                                  child: CBrandsCheckBoxListTileAdSellWidget(),
                                );
                              },
                        ...
                        FutureBuilder<ApiCallResponse>(
                          future: SupabaseInfoGroup.myAdsInfoCall.call(
                            ...
                            return Builder(
                              builder: (context) {
                                ...
                                return ListView.builder(
                                  ...
                                  itemBuilder: (context, buyerAdsBodyIndex) {
                                    final buyerAdsBodyItem =
                                        buyerAdsBody[buyerAdsBodyIndex];
                                    return Padding(
                                                                ...
                                                                await showDialog(
                                                                  ...
                                                                  builder:
                                                                    ...
                                                                    return AlertDialog(
                                                                      title: Text(
                                                                          'Ошибка'),
                                                                      content: Text((_model.apiResultwxc?.jsonBody ??
                                                                              '')
                                                                          .toString()),
                                                                      actions: [
                                                                        TextButton(
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return Wrap(
                                                                          ...
                                                                          children: List.generate(
                                                                              wrapCarModelsRowList.length,
                                                                              (wrapIndex) {
                                                                            final wrapCarModelsRow =
                                                                                wrapCarModelsRowList[wrapIndex];
                                                                            return Material(
                                                                              color: Colors.transparent,
                                                                              shape: RoundedRectangleBorder(
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return Wrap(
                                                                          ...
                                                                          clipBehavior:
                                                                              Clip.none,
                                                                          children: List.generate(
                                                                              wrapPartsCategoryRowList.length,
                                                                              (wrapIndex) {
                                                                            final wrapPartsCategoryRow =
                                                                                wrapPartsCategoryRowList[wrapIndex];
                                                                            return Material(
                                                                              color: Colors.transparent,
                                                                              shape: RoundedRectangleBorder(
                                                                                borderRadius: BorderRadius.circular(8.0),
                                                              ...
                                                              if (getJsonField(
                                                                ...
                                                                Align(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onPressed:
                                                                        () async {
                                                                      _model.aliveFalse = await SupabaseInfoGroup
                                                                          .diedAdInfoCall
                                                                          .call(
                                                                        adId:
                                                                            getJsonField(
