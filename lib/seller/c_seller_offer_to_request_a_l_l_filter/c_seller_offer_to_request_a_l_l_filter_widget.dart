                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Align(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              '4pvjgbre' /* Связаться с покупателем */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                        ...
                        if (false)
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              highlightColor: Colors.transparent,
                              onTap: () async {
                                _model.chatRequest = await RPCChatsGroup
