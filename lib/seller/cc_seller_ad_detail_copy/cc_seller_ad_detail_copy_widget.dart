...
import 'cc_seller_ad_detail_copy_model.dart';
export 'cc_seller_ad_detail_copy_model.dart';

class CcSellerAdDetailCopyWidget extends StatefulWidget {
  const CcSellerAdDetailCopyWidget({
    super.key,
  ...
  @override
  State<CcSellerAdDetailCopyWidget> createState() =>
      _CcSellerAdDetailCopyWidgetState();
}

class _CcSellerAdDetailCopyWidgetState extends State<CcSellerAdDetailCopyWidget>
    with TickerProviderStateMixin {
  late CcSellerAdDetailCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CcSellerAdDetailCopyModel());
                                        ...
                                        Align(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              '9imkiy3n' /* Связаться с покупателем */,
                                            ),
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Align(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              '8wq8epij' /* Связаться с покупателем */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                        ...
                        if (false)
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              highlightColor: Colors.transparent,
                              onTap: () async {
                                _model.chatReqOrig = await RPCChatsGroup
                                    .chGetOrCreateChatCall
                                    .call(
                                  buyerID: FFAppState().userIdApp,
                                  sellerID: getJsonField(
