    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case AdsRow:
            return AdsRow(data);
          case AdsViewsUniqueRow:
            return AdsViewsUniqueRow(data);
          case AppVersionsRow:
            return AppVersionsRow(data);
          case AutoCheckRow:
            return AutoCheckRow(data);
          case BannersRow:
            return BannersRow(data);
          case CarBrandsRow:
            return CarBrandsRow(data);
          case CarModelsRow:
            return CarModelsRow(data);
          case ChatPresenceRow:
            return ChatPresenceRow(data);
          case ChatsRow:
          ...
          case DataUsersRow:
            return DataUsersRow(data);
          case FeedbacksRow:
            return FeedbacksRow(data);
          case FeedbacksNotesRow:
            return FeedbacksNotesRow(data);
          case FiltersRow:
          ...
          case OffersRow:
            return OffersRow(data);
          case OffersNotesRow:
            return OffersNotesRow(data);
          case OrdersRow:
            return OrdersRow(data);
          case PartsCategoryRow:
            return PartsCategoryRow(data);
          case RequestsRow:
            return RequestsRow(data);
          case RequestsFiltersRow:
            return RequestsFiltersRow(data);
          case RequestsNotesRow:
            return RequestsNotesRow(data);
          case RequestsViewsUniqueRow:
            return RequestsViewsUniqueRow(data);
          case RolesRow:
            return RolesRow(data);
          case SellerProfilesRow:
            return SellerProfilesRow(data);
          case SellerRequestsRow:
            return SellerRequestsRow(data);
          case SellerSpecializationsRow:
            return SellerSpecializationsRow(data);
          case SpecializationsRow:
            return SpecializationsRow(data);
          case UserDeviceLinksRow:
            return UserDeviceLinksRow(data);
          case UserDevicesRow:
            return UserDevicesRow(data);
          case UserSessionsRow:
            return UserSessionsRow(data);
          case VehicleUsersRow:
            return VehicleUsersRow(data);
          case YearsRow:
            return YearsRow(data);
          default:
            return null;
        }
