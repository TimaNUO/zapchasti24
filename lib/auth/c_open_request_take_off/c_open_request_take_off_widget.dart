...
import 'c_open_request_take_off_model.dart';
export 'c_open_request_take_off_model.dart';

class COpenRequestTakeOffWidget extends StatefulWidget {
  const COpenRequestTakeOffWidget({
    super.key,
  ...
  @override
  State<COpenRequestTakeOffWidget> createState() =>
      _COpenRequestTakeOffWidgetState();
}

class _COpenRequestTakeOffWidgetState extends State<COpenRequestTakeOffWidget>
    with TickerProviderStateMixin {
  late COpenRequestTakeOffModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => COpenRequestTakeOffModel());
                                                      ...
                                                      child: Padding(
                                                        ...
                                                        child: Text(
                                                          FFLocalizations.of(
                                                                  context)
                                                              .getText(
                                                            '09r8a2e9' /* Состояние автозапчастей */,
                                                          ),
                                                          textAlign:
                                                              TextAlign.center,
                                                          style: FlutterFlowTheme
                                ...
                                child: FutureBuilder<List<CountriesRow>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    return FlutterFlowDropDown<int>(
                                      ...
                                      hintText:
                                          FFLocalizations.of(context).getText(
                                        'vuaksh2q' /* Выберите страну продавца */,
                                      ),
                                      icon: Icon(
                                ...
                                child: FutureBuilder<List<CitiesRow>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    return FlutterFlowDropDown<int>(
                                      ...
                                      hintText:
                                          FFLocalizations.of(context).getText(
                                        '35wykb92' /* Выберите город продавца */,
                                      ),
                                      icon: Icon(
                                        Icons.keyboard_arrow_down_rounded,
                                        color: FlutterFlowTheme.of(context)
