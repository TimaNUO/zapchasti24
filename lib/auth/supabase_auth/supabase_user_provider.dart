...
class Zapchasti24SupabaseUser extends BaseAuthUser {
  Zapchasti24SupabaseUser(this.user);
  User? user;
...
Stream<BaseAuthUser> zapchasti24SupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = Zapchasti24SupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
