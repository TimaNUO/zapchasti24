...
class SupabaseAuthManager extends AuthManager with EmailSignInManager {
  ...
  Future updateEmail({
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
          content: Text(FFLocalizations.of(context).getText(
        'gktuvcwv' /* Отправлено электронное письмо ... */,
      ))),
    );
  }
  ...
  Future resetPassword({
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
          content: Text(FFLocalizations.of(context).getText(
        '2a6iuvba' /* Отправлено электронное письмо ... */,
      ))),
    );
  }
  ...
  Future<BaseAuthUser?> _signInOrCreateAccount(
    ...
    try {
      ...
      final authUser = user == null ? null : Zapchasti24SupabaseUser(user);
      ...
      final errorMsg = e.message.contains('User already registered')
          ? FFLocalizations.of(context).getText(
              '8goevkzm' /* Электронная почта, которая уже... */,
            )
          : FFLocalizations.of(context).getText(
              'mynpwgmx' /* Ошибка */,
            );
